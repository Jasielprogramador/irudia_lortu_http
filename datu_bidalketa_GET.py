...
#pones esto porque en el datu eskaera de get pides el baliabide directamente desde el uri
#adib:https://egela.ehu.eus?9878
#el edukia es lo que le pasas tuuuuuu
uria_datuekin = uria +'?'+edukia

erantzuna = requests.request(metodoa, uria_datuekin, data=edukia, headers=goiburuak, allow_redirects=False)
